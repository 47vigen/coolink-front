  ...
  return (
    ...
    >
      ...
      <footer>
        <Link
          href="/"
          className="block w-20 p-1 mx-auto rounded-md border border-white border-opacity-50"
