      ...
      <div className="flex items-stretch space-s-4 lg:space-s-8">
        ...
        >
          <div className="flex flex-col sticky top-4 items-center lg:items-start space-y-5 text-2xl">
            <MenuItem pathname="/dashboard" notInclude label="داشبورد">
              {({ active }) => (
                <div
